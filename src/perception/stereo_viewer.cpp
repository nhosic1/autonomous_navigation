...
public:
    StereoViewer() : Node("stereo_viewer")
    {
        ...
        if (rectify_)
        {
            ...
            cv::Mat P_L, P_R, T, Q;
            sp::load_stereo_camera_parameters(stereo_camera_params_path, camera_matrix_L_, dist_coeffs_L_, map_1_L_, map_2_L_, P_L, camera_matrix_R_, dist_coeffs_R_, map_1_R_, map_2_R_, P_R, T, Q);
        }
